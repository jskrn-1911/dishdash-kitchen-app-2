...
interface kitchen {
  ...
  slogan: string;
  description: string;
  kitchenProfilePhoto: string | File;
...
const Profile = () => {
  ...
  const [data, setData] = useState<kitchen | null>(kitchenData);
      ...
      <div className="mx-auto max-w-242.5">
        ...
        <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="relative z-20 h-35 md:h-65">
            {data?.kitchenImages?.length ? (
              <Swiper
                modules={[Navigation, Pagination]}
                navigation
                pagination={{ clickable: true }}
                loop={true}
                className="relative h-[200px] sm:h-[260px] w-full overflow-hidden rounded-tl-sm rounded-tr-sm"
              >
                {data?.kitchenImages?.map((imageUrl, index) => (
            ...
            <div className="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4">
              <Link href="/profile/update" title="Update Profile" className="relative inline-block">
                <label
                  htmlFor="cover"
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              ...
              <p className="font-medium">-{kitchenData?.ownerName}-</p>
              <p className="font-medium pt-3">+{kitchenData?.phoneNumber}</p>
              <div className="mx-auto mb-5.5 mt-4.5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
                <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                  <span className="font-semibold text-black dark:text-white">
                    {kitchenData?.rating || "no data"}
                  </span>
                  <span className="text-sm">Rating</span>
                </div>
                <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                  <span className="font-semibold text-black dark:text-white">
                    {kitchenData?.totalReviews || "no data"}
                  </span>
                  <span className="text-sm">Reviews</span>
                </div>
                <div className="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
                  <span className="font-semibold text-black dark:text-white">
                    {kitchenData?.totalOrders || "no data"}
                  </span>
              ...
              <div className="mx-auto max-w-180">
                ...
                <p className="font-medium pb-2 text-black dark:text-white"> --{kitchenData?.slogan}--</p>
                <p className="mt-4.5">
